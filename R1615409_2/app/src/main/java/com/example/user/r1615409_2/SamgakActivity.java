...
@SuppressLint("NewApi")
public class SamgakActivity extends Activity {
    TextView textview;
    Document doc = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samgak);
        textview = (TextView) findViewById(R.id.text);
        GetXMLTask task = new GetXMLTask(this);
        task.execute("http://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=1130557500");
    }
